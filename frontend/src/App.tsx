        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}
          ...
          <Routes>
            <Route element={<Layout><Outlet /></Layout>}>
              ...
              <Route path="/voluntario/:id" element={ <PrivateRoute><VolunteerDetails /></PrivateRoute>} />
              ...
              <Route path="/organizacao/:id/edit" element={ <PrivateRoute> <ProfileEdit profile={'institution'} /> </PrivateRoute>} />
              <Route path="/organizacao/:idInstitution/oportunidade/:idOpportunity" element={<OpportunityDetails />} />
              <Route path="/organizacao/:idInstitution/oportunidade/:idOpportunity/voluntarios" element={<PrivateRoute><VolunteersOpportunity /></PrivateRoute>} />
            </Route>
          </Routes>
